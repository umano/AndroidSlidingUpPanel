...
public class SlidingDownPanelLayout extends ViewGroup {
    ...
    /**
     * Default height of the shadow below the peeking out panel
     */
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int childTop = lp.slideable ? slidingTop - (int) (mSlideRange * mSlideOffset) : paddingTop + mPanelHeight;
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            int top = getSlidingTop() - mSlideRange;

            if (mAnchorPoint != 0) {
                int anchoredTop = mPanelHeight - (int)(mAnchorPoint*mSlideRange);
                float anchorOffset = (float)(mPanelHeight - anchoredTop)/(float)mSlideRange;
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            ...
            final int topBound = bottomBound - mSlideRange;
